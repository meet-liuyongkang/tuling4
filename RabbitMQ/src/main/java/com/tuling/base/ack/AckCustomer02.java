    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        DeliverCallback deliverCallback = new DeliverCallback() {
            ...
            public void handle(String consumerTag, Delivery message) throws IOException {
                ...
                System.out.println("02收到消息: consumerTag=" + consumerTag + ",  body=" + new String(message.getBody()));
                 ...
                 * 2. multiple：是否批量应答，如果为false，则只会应答当前消息。如果为true，则当前消息及之前收到的消息，一次全部应答。
                 */
        ...
        channel.basicConsume(AckProducer.QUEUE_NAME, false, deliverCallback, cancelCallback);
